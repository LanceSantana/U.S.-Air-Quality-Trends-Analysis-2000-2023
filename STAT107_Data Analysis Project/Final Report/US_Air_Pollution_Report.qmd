...
##LANCE Reads and cleans pollution data set:
...
1: carbon monoxide in the country and pin point the cities with the highest and lowesr rates using maps().
...
2: How has the average carbon monoxide (CO) level changed yearly in Phoenix? Task: Filter the dataset for Phoenix and plot the yearly average of CO Mean values. Air Quality Map by State
